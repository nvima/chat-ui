<template>
    ...
    <!--Theme switch-->
    <div style="cursor: pointer; position: fixed; top: 180px; right: 0px; margin: 20px" :style="darkTheme && 'color: #fff'"
...
<script setup>
import { ref } from 'vue'
import Chat from '../../../output/vue/vue3/src/components/Chat.vue'
const data = ref([
